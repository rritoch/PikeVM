...
"C:\Program Files\Pike\bin\pike"  -m %PIKEMASTER% %PIKESYS% -I "C:\Program Files\Pike\lib\include" -M "C:\Program Files\Pike\lib\modules" 2>%PIKELOGERR% 
GOTO FINISH
:NEWOS
...
"C:\Program Files (x86)\Pike\bin\pike" -m %PIKEMASTER% %PIKESYS% -I "C:\Program Files (x86)\Pike\lib\include" -M "C:\Program Files (x86)\Pike\lib\modules"  
GOTO FINISH
